        ...
        <div style="padding: 18px;">
            <table class="custom-table">
                <tr>
                    ...
                    <td><h2 style="float: right">INVOICE</h2></td>
                </tr>
            </table>
                ...
                <tr>
                    ...
                    <td style="width: 50px">
                        <table>
                            <tr>
                                <td>
                                    <h5 style="margin: 10px 0px; width: 50%;">Invoice #</h5>
                                </td>
                                <td>
                                    <span style="margin: 10px 0px;  width: 50%;">#6</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h5 style="margin: 10px 0px; width: 50%;">Order Id</h5>
                                </td>
                                <td>
                                    <span style="margin: 10px 0px;  width: 50%;">{{ $id ?? '' }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h5 style="margin: 10px 0px; width: 50%;">Order Date</h5>
                                </td>
                                <td>
                                    <span
                            ...
                            <tr>
                                <td>
                                    <h5 style="margin: 10px 0px; width: 50%;">Payment Method</h5>
                                </td>
                                <td>
                                    <span style="margin: 10px 0px;  width: 50%;">
                            ...
                            <tr>
                                <td>
                                    <h5 style="margin: 10px 0px; width: 50%;">Service Type</h5>
                                </td>
                                <td>
                                    <span style="margin: 10px 0px;  width: 50%;">

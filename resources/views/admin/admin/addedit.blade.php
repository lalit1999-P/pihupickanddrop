    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">{{ isset($User->id) ? 'Admin Update' : 'Admin Add' }} </h3>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ isset($User->id) ? 'Admin Update' : 'Admin Add' }}
                            </li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (isset($User))
                                                    @if (isset($User))
                                                        <img src="{{ asset('images/admin_image') . '/' . $User->image }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a class="btn btn-info mx-3" href=" {{ route('admin') }} "
                                                    value="Back"> Back </a>
                                            </div>
                                        </div>
                                    </div>
